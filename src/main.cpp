...
int main(int argc, char **argv)
{
    ...
    /* Get the percent of developer fee to donate. (Optional, but thank you !!!). */
    ...
    if(nPrimeGPU || nPrimeCPU)
    {
        ...
        prime::load_config(primeIndices);
    ...
    /* Start CUDA profiler. */
    if(config::GetBoolArg(std::string("-profile")))
        cuda_profiler_start();
